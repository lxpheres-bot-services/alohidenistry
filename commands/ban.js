...
module.exports.run = async (bot, message, args) => {
	...
	await bot.guilds.get("503074702902689803").channels.get("506303108998234133").send(`:Ban: **${member.user.tag}** has been banned by ${message.author.tag} because of: **${reason}**!`);
};
