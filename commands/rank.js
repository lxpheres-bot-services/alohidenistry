...
module.exports.run = async (bot, message, args) => {
	if (!message.member.roles.get("620375972818059273")) return message.reply("Invalid permissons! You must have the `Bot Admin` role.").catch(() => bot.safeSend(message, module.exports.help.name));
